...
public class BrandController {
	...
	public ResponseEntity<?> addingbrand(@Valid @RequestParam String brandName,@RequestPart("image") MultipartFile image) {
	...
	public ResponseEntity<?> updatebrand(@PathVariable Integer brandId,@Valid @RequestParam String brandName,

...
public class CategoryController {
	...
	public ResponseEntity<?> addCate(@Valid @RequestParam String categoryName, @RequestParam String cateDescription, @RequestPart MultipartFile image){
	...
	public ResponseEntity<?> updatecate(@PathVariable Integer categoryId,@Valid @RequestParam String categoryName, @RequestParam String cateDescription,@RequestPart MultipartFile image){
